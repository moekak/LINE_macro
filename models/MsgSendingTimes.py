...
class MsgSendingTimes: 
      ...
      def updateFlag(self, device_id, driver, username):
      ...
      def selectStartAndEndId(self, device_id, driver, username):
            try:
      ...
      def getEndId(self,device_id, driver, username):
            data = self.selectStartAndEndId(device_id, driver, username)
            end_id = ""
      ...
      def IncreaseEndId(self, device_id, username):
      ...
      def updateEndId(self, device_id, driver, username):
            try:
